 ...
 */
class checklistbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "checklist@checklist";
    public $boxlabel;
    public $depends = array("checklist");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/checklist/class/checklist.class.php";
